...
* ZMK is pinned to **[v0.3](https://github.com/zmkfirmware/zmk/releases)** in `config/west.yml` and in `.github/workflows/build.yml` (see [pinning ZMK](https://zmk.dev/blog/2025/06/20/pinned-zmk)).
